...
namespace SharpDXExamples.Examples.ModelRendering3D {
    public class LightShader {
        ...
        public bool Initialize(Device device) {
            if(!InitializeShader(device, @"Examples\ModelRendering3D\Shaders\Light.vs", @"Examples\ModelRendering3D\Shaders\Light.ps"))
                return false;
        ...
        public bool Render(DeviceContext deviceContext, int indexCount, Matrix world, Matrix view, Matrix projection, ShaderResourceView texture, Vector3 lightDirection, Color4 diffuseColor) {
        ...
        bool SetShaderParameters(DeviceContext deviceContext, Matrix world, Matrix view, Matrix projection, ShaderResourceView texture, Vector3 lightDirection, Color4 diffuseColor) {
            try {
