...
namespace SharpDXExamples.Examples.MultitexturingAndTextureArrays {
    public class Model {
        ...
        public bool Initialize(Device device, string modelFileName, string textureFileName1, string textureFileName2) {
        ...
        bool LoadTexture(Device device, string fileName1, string fileName2) {
            textureArray = new TextureArray();
            if(!textureArray.Initialize(device, fileName1, fileName2))
                return false;
