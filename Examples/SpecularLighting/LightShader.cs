...
namespace SharpDXExamples.Examples.SpecularLighting {
    public class LightShader {
        ...
        public bool Initialize(Device device) {
            if(!InitializeShader(device, @"Examples\SpecularLighting\Shaders\Light.vs", @"Examples\SpecularLighting\Shaders\Light.ps"))
                return false;
        ...
        public bool Render(DeviceContext deviceContext, int indexCount, Matrix world, Matrix view, Matrix projection, ShaderResourceView texture, Vector3 lightDirection, Color4 ambientColor, Color4 diffuseColor, Vector3 cameraPosition, Color4 specularColor, float specularPower) {
            if(!SetShaderParameters(deviceContext, world, view, projection, texture, lightDirection, ambientColor, diffuseColor, cameraPosition, specularColor, specularPower))
                return false;
        ...
        bool SetShaderParameters(DeviceContext deviceContext, Matrix world, Matrix view, Matrix projection, ShaderResourceView texture, Vector3 lightDirection, Color4 ambientColor, Color4 diffuseColor, Vector3 cameraPosition, Color4 specularColor, float specularPower) {
            try {
