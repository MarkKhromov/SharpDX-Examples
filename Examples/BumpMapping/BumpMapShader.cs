...
namespace SharpDXExamples.Examples.BumpMapping {
    public class BumpMapShader {
        ...
        public bool Initialize(Device device) {
            if(!InitializeShader(device, @"Examples\BumpMapping\Shaders\BumpMap.vs", @"Examples\BumpMapping\Shaders\BumpMap.ps"))
                return false;
        ...
        public bool Render(DeviceContext deviceContext, int indexCount, Matrix world, Matrix view, Matrix projection, ShaderResourceView[] textureArray, Vector3 lightDirection, Color4 diffuseColor) {
            if(!SetShaderParameters(deviceContext, world, view, projection, textureArray, lightDirection, diffuseColor))
                return false;
        ...
        bool SetShaderParameters(DeviceContext deviceContext, Matrix world, Matrix view, Matrix projection, ShaderResourceView[] textureArray, Vector3 lightDirection, Color4 diffuseColor) {
            try {
